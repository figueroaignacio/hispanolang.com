...
export const lesson: LessonContent = {
  ...
  description: 'Aprende a documentar tu código como si fuera una receta de cocina',
...
mostrar panquequesHechos`,
      ...
      validation: {
        requiredCode: ['/\\/\\/.*RECETA/i', '/tortillasHechas.*0/', '/mostrar/'],
        expectedOutputs: ['/0/'],
      },
    },
    {
...
pasoActual = pasoActual + 1  // Siguiente paso`,
      ...
      validation: {
        requiredCode: ['/TEMPERATURA_HORNO.*180.*\\/\\//', '/minutosHorneado.*0/', '/mostrar/'],
        expectedOutputs: ['/0/'],
      },
    },
    {
...
// mostrar "Debug: azúcar usada = " + AZUCAR  // Solo para pruebas`,
      ...
      validation: {
        requiredCode: ['/\\/\\/.*mostrar/', '/\\/\\/.*mostrar/', '/mostrar\\s+/', '/mostrar\\s+/'],
      },
    },
    {
