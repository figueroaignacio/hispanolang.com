...
variable subtotal = precio _ cantidad
variable conIVA = subtotal _ (1 + iva)
retornar conIVA
}
...
mostrar "Descuento: " + (tipoDescuento(120) _ 100) + "%" // Descuento: 30%
mostrar "Descuento: " + (tipoDescuento(60) _ 100) + "%" // Descuento: 20%`} />
