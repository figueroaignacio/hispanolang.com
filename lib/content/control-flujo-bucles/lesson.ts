...
mostrar "Terminado"`,
      ...
      challenge:
        "Busca el número 7 en una secuencia del 1 al 20. Usa 'romper' cuando lo encuentres y muestra 'Encontrado: 7'.",
      validation: {
...
mientras i < 5 {
    ...
    mostrar i
      ...
      challenge:
        "Bucle del 1 al 10. Usa 'continuar' para saltar los números pares. Muestra solo impares.",
      validation: {
...
para (variable j = 1; j <= 5; j = j + 1) {
    ...
    mostrar j
      ...
      challenge:
        "Crea dos bucles del 1 al 10. En uno usa 'romper' en 6, en otro 'continuar' en 6. Muestra ambos resultados.",
      validation: {
...
para (variable i = 0; i < numeros.longitud(); i = i + 1) {
    ...
    romper
      ...
      explanation:
        "Filtramos pares con 'continuar' y terminamos con 'romper' al encontrar el primero impar.",
