...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Aprende a organizar datos con propiedades usando objetos en HispanoLang.',
...
export default function ObjetosLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
