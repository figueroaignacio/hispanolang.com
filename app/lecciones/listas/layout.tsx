...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Aprende a trabajar con colecciones de datos usando listas en HispanoLang.',
...
export default function ListasLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
