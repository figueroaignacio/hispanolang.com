...
export const metadata: Metadata = {
  ...
  keywords: ['métodos strings español', 'manipular texto', 'cadenas texto HispanoLang'],
  alternates: {
    canonical: 'https://hispanolang.com/lecciones/metodos-strings',
  },
};

export default function MetodosStringsLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
