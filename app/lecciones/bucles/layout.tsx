...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Aprende a repetir acciones automáticamente con bucles en HispanoLang.',
...
export default function BuclesLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
