...
export const metadata: Metadata = {
  ...
  keywords: ['operadores programación español', 'matemáticas código', 'comparaciones HispanoLang'],
  alternates: {
    canonical: 'https://hispanolang.com/lecciones/operadores',
  },
};

export default function OperadoresLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
