...
export const metadata: Metadata = {
  ...
  keywords: ['comentarios código español', 'documentar código', 'HispanoLang comentarios'],
  alternates: {
    canonical: 'https://hispanolang.com/lecciones/comentarios',
  },
};

export default function ComentariosLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
