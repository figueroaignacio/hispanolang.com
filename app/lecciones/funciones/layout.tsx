...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Aprende a crear código reutilizable con funciones en HispanoLang.',
...
export default function FuncionesLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
