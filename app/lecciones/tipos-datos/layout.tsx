...
export const metadata: Metadata = {
  ...
  keywords: ['tipos datos español', 'números texto booleanos', 'HispanoLang tipos datos'],
  alternates: {
    canonical: 'https://hispanolang.com/lecciones/tipos-datos',
  },
};

export default function TiposDatosLessonLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
