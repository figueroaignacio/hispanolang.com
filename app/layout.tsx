  ...
  return (
    <html lang="es" className="dark">
      <head>
        ...
        <meta property="og:image:secure_url" content="https://hispanolang.com/hl-og.png" />

        {/* Twitter adicionales */}
        <meta name="twitter:image:src" content="https://hispanolang.com/hl-og.png" />
        <meta name="twitter:image:alt" content="HispanoLang - Programa en Español" />
      </head>
