...
export default function Card({
  ...
  const variantClasses = {
    ...
    elevated: 'bg-slate-800/50 shadow-lg hover:shadow-xl border border-slate-700/50',
    glass: 'bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 shadow-lg',
    interactive:
